...
namespace SwebONE.Attendance
{
    partial class FrmAttendanceList : Swebui.Controls.SwebUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewColumn1.DisplayMember = "AT_ID";
            gridViewColumn1.HeaderText = "ID";
            gridViewColumn2.DisplayMember = "AT_Name";
            gridViewColumn2.HeaderText = "考勤名称";
            gridViewColumn3.DisplayMember = "AT_EffectiveDesc";
            gridViewColumn3.HeaderText = "生效时间";
            gridViewColumn4.DisplayMember = "WorkDate";
            gridViewColumn4.HeaderText = "上下班描述";
            gridViewColumn5.DisplayMember = "WorkDate1";
            gridViewColumn5.HeaderText = "上下班描述1";
            gridViewColumn6.DisplayMember = "AT_WeeklyWorkingDay";
            gridViewColumn6.HeaderText = "每周工作日";
