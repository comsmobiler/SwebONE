...
namespace SwebONE.RB
{
    partial class FrmRBList : Swebui.Controls.SwebUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewColumn1.DisplayMember = "ID";
            gridViewColumn1.HeaderText = "ID";
            gridViewColumn2.DisplayMember = "L_StatusDesc";
            gridViewColumn2.HeaderText = "状态";
            gridViewColumn3.DisplayMember = "CreateDate";
            gridViewColumn3.HeaderText = "创建日期";
            gridViewColumn4.DisplayMember = "RB_TotalAmount";
            gridViewColumn4.HeaderText = "总计金额";
            ...
            this.gridView1,
            this.lblInfor});
            this.Load += new System.EventHandler(this.FrmRBList_Load);
