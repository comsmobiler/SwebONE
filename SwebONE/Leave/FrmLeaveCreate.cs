...
namespace SwebONE.Leave
{
    ...
    partial class FrmLeaveCreate : Swebui.Controls.SwebUserControl
    {
        ...
        private void Bind()
        {
            try
            {
                ...
                if (LID != null)
                {
                    ...
                    type = leave.L_TypeID;
                    btnType.DefaultValue = new string[] { leave.L_TypeID };
                    ...
                    if (leave.L_CheckUsers != null)
                    {
                        ...
                        comboBox2.DefaultValue = CheckUsers;
                    }
                    //获取抄送人
                    if (string.IsNullOrEmpty(leave.L_CCTo) == false)
                    {
                        ...
                        comboBox3.DefaultValue = CCToUsers;
                    }
                }
            }
            catch (Exception ex)
        ...
        private void GetDate()
        {
            ...
            {
                btnType.Nodes.Add(new TreeSelectNode(leaveType.L_T_ID, leaveType.L_T_Name));
            }
        ...
        private void comboBox2_Press(object sender, TreeSelectPressEventArgs args)
        {
            ...
            if (args.Selections.Length > 4)
            {
                Toast("请选择1-4名审核人");
            }
            else
            {
                foreach (var use in args.Selections)
                {
                    listCheckUsers.Add(use);
                }
            }
