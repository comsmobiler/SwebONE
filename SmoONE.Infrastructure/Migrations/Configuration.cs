    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SmoONE.Infrastructure.SmoONEDbContext>
    {
        ...
        protected override void Seed(SmoONE.Infrastructure.SmoONEDbContext context)
        {
            ...
            context.Menus.AddOrUpdate(
                new Menu { M_MenuID = "Home", M_Description = "主页", M_Sort = 0, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "home" },
                new Menu { M_MenuID = "UserCenter", M_Description = "个人中心", M_Sort = 1, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "user-o" },         
                new Menu { M_MenuID = "Attendance", M_Description = "考勤管理", M_Sort = 2, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "calendar-check-o" },
                new Menu { M_MenuID = "AttendanceManagement", M_Description = "考勤管理", M_Sort = 1, M_IsActive = 1, M_ParentID = "Attendance", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "MyAttendanceHistory", M_Description = "我的考勤", M_Sort = 2, M_IsActive = 1, M_ParentID = "Attendance", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "AttendanceStatistics", M_Description = "考勤统计", M_Sort = 3, M_IsActive = 1, M_ParentID = "Attendance", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "RB", M_Description = "报销管理", M_Sort = 3, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "file-o" },
                new Menu { M_MenuID = "Leave", M_Description = "请假管理", M_Sort =4, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "file-text-o" },
                new Menu { M_MenuID = "EA", M_Description = "审批管理", M_Sort = 5, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "check-square-o" },
                new Menu { M_MenuID = "NeedEA", M_Description = "待审批", M_Sort = 1, M_IsActive = 1, M_ParentID = "EA", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "AlreadyEA", M_Description = "已审批", M_Sort =2, M_IsActive = 1, M_ParentID = "EA", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "Department", M_Description = "部门管理", M_Sort = 6, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "sitemap" },
                new Menu { M_MenuID = "CC", M_Description = "成本中心", M_Sort = 7, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "university" },
                new Menu { M_MenuID = "CCFX", M_Description = "成本分析", M_Sort = 3, M_IsActive = 1, M_ParentID = "CC", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "CC_Type_Template", M_Description = "成本模板", M_Sort = 1, M_IsActive = 1, M_ParentID = "CC", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "CostCenter", M_Description = "成本中心", M_Sort = 2, M_IsActive = 1, M_ParentID = "CC", M_UpdateDate = DateTime.Now, M_Portrait = "circle" },
                new Menu { M_MenuID = "FileUp", M_Description = "文件管理", M_Sort = 8, M_IsActive = 1, M_ParentID = "", M_UpdateDate = DateTime.Now, M_Portrait = "files-o" }
                  );
            //在RoleMenu表中添加默认数据
